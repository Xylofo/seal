...
\begin{abstract}
    ...
    powers of 3, presenting narrower bounds and or explicit formulas.
...
\end{center}
    ...
    Svaren på frågorna verkar betydligt svårare och kan ge insikt i ett antal andra frågor.	
    ...
    Detta är ett av millenieproblemen och en lösning 
	...
	$a$ så att $\underset{x\to\infty}{\lim} \frac{\C{a}}{\log{a}} \le \frac{3}{\log{3}}$
