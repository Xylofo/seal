...
\section{Algoritmer för att generera sekvensen}
    ...
    \subsection{Fler algoritmer och diskussion}
        ...
        svårt problem vilket är därför vi inte förklarar algoritmen här. Denna
        algoritm är den som är använd för att kunna undersöka egenskaper av
        $\C{n}$, exempelvis dess invers, hur tajta gränserna är och hitta
        motexempel till hypoteser.

        Som en sammanfattning listas nedan en tabell över de olika algoritmerna 
        med respektive tidskomplexitet och minneskomplexitet \cref{tbl}.
